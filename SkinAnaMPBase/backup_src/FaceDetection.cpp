...
void FaceDetector::detect(cv::Mat img, std::vector<FaceBoxInfo>& faces,
...
void FaceDetector::postProcess(
        ...
        std::vector<FaceBoxInfo>& faces, float heatmapThreshold, float nmsThreshold){
	...
	std::vector<FaceBoxInfo> faces_tmp;
...
void FaceDetector::nms(std::vector<FaceBoxInfo>& input, std::vector<FaceBoxInfo>& output,
		float nmsThreshold){

	std::sort(input.begin(), input.end(),
		[](const FaceBoxInfo& a, const FaceBoxInfo& b){return a.score > b.score;});
...
void FaceDetector::getBox(std::vector<FaceBoxInfo>& faces){
