...
void ForgeOneEyePg(const Point2i eyeRefinePts[71], POLYGON& outPolygon)
{
    ...
    CloseSmoothPolygon(coarsePg, csNumPoint, outPolygon);
}
...
void ForgeEyesMask(const FaceInfo& faceInfo, Mat& outMask)
{
    ...
    ForgeOneEyePg(faceInfo.lEyeRefinePts, leftEyePg);
    ForgeOneEyePg(faceInfo.rEyeRefinePts, rightEyePg);
